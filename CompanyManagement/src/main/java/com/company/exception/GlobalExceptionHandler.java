...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> companyException(CompanyException e, WebRequest req) {
	...
	public ResponseEntity<MyErrorDetails> EmployeeExceptionException(EmployeeException e, WebRequest req) {
