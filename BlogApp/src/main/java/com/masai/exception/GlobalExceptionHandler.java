...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> myExpHandler(CommentException ie, WebRequest req){
	...
	public ResponseEntity<MyErrorDetails> myExpHandler(BlogException ie, WebRequest req){
