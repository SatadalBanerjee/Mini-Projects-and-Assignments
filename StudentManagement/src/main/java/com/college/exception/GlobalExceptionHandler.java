...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> userException(StudentException e, WebRequest req) {
	...
	public ResponseEntity<MyErrorDetails> emailException(CollegeException e, WebRequest req) {
